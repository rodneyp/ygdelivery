function ygdelivery_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
ygdelivery_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				ygdelivery_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
ygdelivery_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
ygdelivery_xmlhttpRequester.prototype.setupRequestEvent =
